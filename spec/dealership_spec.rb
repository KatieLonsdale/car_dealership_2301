...
RSpec.describe Dealership do
  ...
  describe '#details' do
    it 'returns hash with dealership total value and address' do
      ...
      expect(dealership.details).
      to eq({"total_value" => 156000, "address" => "123 Main Street"})
    end
  end
  ...
  it 'returns hash of inventory with cars grouped by make' do
    dealership = Dealership.new("Acme Auto", "123 Main Street")
    ...
    expect(dealership.inventory_hash.flatten).
    to eq(['Ford', [car_1], 'Toyota', [car_2, car_3], 'Chevrolet', [car_4]])
  end
  end
end